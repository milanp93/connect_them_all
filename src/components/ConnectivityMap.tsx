...
const ConnectivityMap: FC<{schoolsAndTowers:PopulationData[], recommended: RecommendationType[]}> = ({schoolsAndTowers, recommended}) => {
...
//   const [topSchools, setTopSchools] = useState<SchoolData[]>([]);
  ...
  // Define custom marker icons if you have them (ensure these images exist in /public)
    ...
    console.log("process.env.GOOGLE_ELEVATION_API_KEY: ",process.env.GOOGLE_ELEVATION_API_KEY)
  return (
